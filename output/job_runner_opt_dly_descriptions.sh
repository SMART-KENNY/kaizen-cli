...
config_filename="gdm_config-opt_dly_descriptions.json"
...
generate_json() {
  ...
  cat > "${json_file}" <<EOF
{
  "source_name": "opt_dly_descriptions",
  "source_directory": "/datahub/talend_prod/data/hive/gdm_landing/optima/opt_dly_descriptions/",
  "valid_filename_prefixes": ["opt_dly_descriptions*"],
  ...
  "target_s3_landing_directory": "opt_dly_descriptions/raw/",
  "target_aws_region": "ap-southeast-1",
  "source_manifest_s3_bucket_name": "${manifest_bucket_name}",
  "source_manifest_s3_landing_directory": "manifests/source_manifest/opt_dly_descriptions/raw/",
  "housekeeping_manifest_s3_bucket_name": "${manifest_bucket_name}",
  "housekeeping_manifest_s3_landing_directory": "manifests/housekeeping_manifest/opt_dly_descriptions/raw/",
  "job_log_s3_bucket_name": "${manifest_bucket_name}",
  "job_log_s3_landing_directory": "logs/job_logs/opt_dly_descriptions/",
